    ...
    <div class="row">
        <div class="col-6">
            ...
            <form method="post" action="/students/{{ $student -> id }}">
                ...
                id="nama" placeholder="Masukkan Nama" name="nama" value="{{ $student ->nama }}"> {{-- old('nama') -> untuk menyimpan history input data dan tidak hilang saat input salah--}}
                    @error('nama') 
                ...
                <a href="/students/{{ $student->id }}" class="btn btn-info">Kembali</a>
              </form>
        </div>
    </div>
</div>
